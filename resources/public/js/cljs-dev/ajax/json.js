...
if(cljs.core.truth_((function (){var and__28111__auto__ = prefix;
if(cljs.core.truth_(and__28111__auto__)){
return cljs.core._EQ_.call(null,(0),text.indexOf(prefix));
} else {
return and__28111__auto__;
}
})())){
...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__30808){
...
var prefix = cljs.core.get.call(null,map__30809__$1,new cljs.core.Keyword(null,"prefix","prefix",-265908465));
var keywords_QMARK_ = cljs.core.get.call(null,map__30809__$1,new cljs.core.Keyword(null,"keywords?","keywords?",764949733));
var raw = cljs.core.get.call(null,map__30809__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
return ajax.interceptors.map__GT_ResponseFormat.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),((function (map__30809,map__30809__$1,prefix,keywords_QMARK_,raw){
...
});})(map__30809,map__30809__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__30808){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__30808);
}
...
//# sourceMappingURL=json.js.map?rel=1504967592384

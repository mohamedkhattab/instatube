...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8788__auto__,writer__8789__auto__,opt__8790__auto__){
return cljs.core._write(writer__8789__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14072 = o;
(G__14072[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14073__delegate = function (args){
...
while (G__14074__i < G__14074__a.length) {G__14074__a[G__14074__i] = arguments[G__14074__i + 0]; ++G__14074__i;}
  args = new cljs.core.IndexedSeq(G__14074__a,0,null);
} 
return G__14073__delegate.call(this,args);};
G__14073.cljs$lang$maxFixedArity = 0;
G__14073.cljs$lang$applyTo = (function (arglist__14075){
var args = cljs.core.seq(arglist__14075);
return G__14073__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__8151__auto__ = !((jsprops == null));
if(and__8151__auto__){
var and__8151__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__14078 = jsprops;
(G__14078["defaultValue"] = value);

(G__14078["onChange"] = ((function (G__14078,v,value,on_change){
return (function (p1__14077_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14077_SHARP_);
});})(G__14078,v,value,on_change))
);
...
var vec__14081 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14081,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14081,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14081,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___14085 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___14085 == null)){
} else {
var key_14086 = temp__4661__auto___14085;
(jsprops["key"] = key_14086);
}
...
var G__14087 = reagent.impl.template.__GT_NativeWrapper();
(G__14087["name"] = c);
...
var G__14088 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14088) : reagent.impl.template.as_element.call(null,G__14088));
} else {
...
var len__9332__auto___14093 = arguments.length;
var i__9333__auto___14094 = (0);
while(true){
if((i__9333__auto___14094 < len__9332__auto___14093)){
args__9339__auto__.push((arguments[i__9333__auto___14094]));

var G__14095 = (i__9333__auto___14094 + (1));
i__9333__auto___14094 = G__14095;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9340__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14091){
var G__14092 = cljs.core.first(seq14091);
var seq14091__$1 = cljs.core.next(seq14091);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14092,seq14091__$1);
});
...
break;
default:
var G__14098 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14098;
continue;
...
var n__9108__auto___14100 = a.length;
var i_14101 = (0);
while(true){
if((i_14101 < n__9108__auto___14100)){
(a[i_14101] = reagent.impl.template.as_element((a[i_14101])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__9108__auto___14103 = a.length;
var i_14104 = (0);
while(true){
if((i_14104 < n__9108__auto___14103)){
var val_14105 = (a[i_14104]);
if((cljs.core.vector_QMARK_(val_14105)) && ((reagent.impl.template.key_from_vec(val_14105) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14104] = reagent.impl.template.as_element(val_14105));
...
var ctx = ({});
var vec__14107 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14107,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14107,(1),null);
...
var G__14110 = (cljs.core.count(argv) - first_child);
switch (G__14110) {
case (0):
...
case (1):
var G__14111 = comp;
var G__14112 = jsprops;
var G__14113 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__14111,G__14112,G__14113) : reagent.impl.template.global$module$react.createElement.call(null,G__14111,G__14112,G__14113));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__14110){

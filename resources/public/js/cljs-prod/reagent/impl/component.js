...
if((i < len)){
var k = (ks[i]);
var G__14025 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__14026 = (i + (1));
m = G__14025;
i = G__14026;
continue;
...
var temp__4659__auto__ = (p["argv"]);
if((temp__4659__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__14027 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__14027) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__14027));
})());
} else {
var v = temp__4659__auto__;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14029 = c;
var G__14029__$1 = (((G__14029 == null))?null:G__14029.prototype);
if((G__14029__$1 == null)){
return null;
} else {
return (G__14029__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14031 = c;
var G__14031__$1 = (((G__14031 == null))?null:G__14031.prototype);
if((G__14031__$1 == null)){
return null;
} else {
return (G__14031__$1["render"]);
}
})() == null)));
});
...
var G__14033 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14033) : reagent.impl.component.as_element.call(null,G__14033));
};
...
var _STAR_current_component_STAR_14039 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14039;
}});
...
return ((function (G__14040,G__14040__$1){
...
var or__8163__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__8163__auto__){
...
var c = this;
var G__14041_14043 = (c["cljsRatom"]);
if((G__14041_14043 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14041_14043);
}
...
if(cljs.core.truth_((function (){var and__8151__auto__ = wrap;
...
var renders_14045 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14046 = cljs.core.first(cljs.core.vals(renders_14045));
if((cljs.core.count(renders_14045) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_14045))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_14046)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_14046], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__8163__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
...
var render_fun__$1 = (function (){var or__8163__auto__ = render_fun;
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8163__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
...
var name__$1 = (function (){var G__14044 = name;
switch (G__14044) {
case "":
...
var G__14049 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__14049) : reagent.impl.component.global$module$create_react_class.call(null,G__14049));
});
reagent.impl.component.component_path = (function reagent$impl$component$component_path(c){
var elem = (function (){var G__14050 = (function (){var or__8163__auto__ = (function (){var G__14052 = c;
if((G__14052 == null)){
return null;
} else {
return (G__14052["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
...
return (G__14050["_currentElement"]);
}
})();
var name = (function (){var G__14053 = elem;
var G__14053__$1 = (((G__14053 == null))?null:(G__14053["type"]));
if((G__14053__$1 == null)){
return null;
} else {
return (G__14053__$1["displayName"]);
}
})();
var path = (function (){var G__14054 = elem;
var G__14054__$1 = (((G__14054 == null))?null:(G__14054["_owner"]));
var G__14054__$2 = (((G__14054__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__14054__$1) : reagent.impl.component.component_path.call(null,G__14054__$1)));
if((G__14054__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14054__$2)," > "].join('');
}
})();
...
var n = (function (){var or__8163__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
var G__14055 = c;
var G__14055__$1 = (((G__14055 == null))?null:G__14055.constructor);
if((G__14055__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14055__$1);
}
}
})();

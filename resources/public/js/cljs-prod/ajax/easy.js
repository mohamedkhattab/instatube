...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__14847 = cljs.core.second(format);
var G__14848 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__14847,G__14848) : ajax.easy.keyword_response_format_element.call(null,G__14847,G__14848));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14851_SHARP_){
return ajax.easy.keyword_response_format_element(p1__14851_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__14852){
var map__14853 = p__14852;
var map__14853__$1 = ((((!((map__14853 == null)))?((((map__14853.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14853.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14853):map__14853);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14853__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14853__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14853__$1,cljs.core.cst$kw$finally);
var h = (function (){var or__8163__auto__ = handler;
...
var e = (function (){var or__8163__auto__ = error_handler;
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
...
return ((function (h,e,map__14853,map__14853__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__14855){
var vec__14856 = p__14855;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14856,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14856,(1),null);
var fexpr__14859_14860 = (cljs.core.truth_(ok)?h:e);
(fexpr__14859_14860.cljs$core$IFn$_invoke$arity$1 ? fexpr__14859_14860.cljs$core$IFn$_invoke$arity$1(result) : fexpr__14859_14860.call(null,result));
...
;})(h,e,map__14853,map__14853__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__14861){
var map__14862 = p__14861;
var map__14862__$1 = ((((!((map__14862 == null)))?((((map__14862.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14862.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14862):map__14862);
var opts = map__14862__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14862__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14862__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14862__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14862__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14862__$1,cljs.core.cst$kw$body);

var needs_format = ((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET"));
var rf = (cljs.core.truth_((function (){var or__8163__auto__ = format;
if(cljs.core.truth_(or__8163__auto__)){
return or__8163__auto__;
} else {
return needs_format;
